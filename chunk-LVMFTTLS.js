import{b as j}from"./chunk-W6EE3F42.js";import{Qb as R,a as M,bb as $,cb as F,k as D,ra as I,sa as T,va as w}from"./chunk-ASRPS2K4.js";import{A as C,Ab as c,Kb as p,Vb as n,Wb as r,Yb as d,Z as v,Zb as s,ca as h,dd as b,ec as m,ed as y,fb as a,gb as u,m as _,rc as t,sc as E,tb as S,tc as f}from"./chunk-TA7IZMCV.js";import"./chunk-Q7L6LLAK.js";var U=(()=>{class i{constructor(e,o){this.http=e,this.router=o,this.apiUrl="https://zaracloud.radioscorpio.be/api/mixer/status",this.authRedirectUrl="https://zaracloud.radioscorpio.be/api/login"}getMixerData(){return this.http.get(this.apiUrl).pipe(C(e=>this.handleError(e)))}handleError(e){return e.status===401&&(console.warn("Unauthorized (401) - Redirecting to login..."),window.location.href=this.authRedirectUrl),_(()=>new Error(e.message))}static{this.\u0275fac=function(o){return new(o||i)(h(M),h(D))}}static{this.\u0275prov=v({token:i,factory:i.\u0275fac,providedIn:"root"})}}return i})();function k(i,l){if(i&1&&(d(0),t(1),s()),i&2){let e=m().$implicit;a(),f(`
                    `,e.filename,`
