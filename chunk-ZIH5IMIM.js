import{b as Q}from"./chunk-DRUIO7WJ.js";import{$ as b,La as I,Ma as w,aa as D,da as y,yb as k}from"./chunk-YNQMBS6W.js";import{a as C,j as _}from"./chunk-UFHHX7OZ.js";import{A as x,Ab as m,Lb as s,Wb as i,Xb as n,Z as f,ca as c,fb as a,fc as E,gb as h,m as u,od as g,pd as S,sc as e,tb as v,tc as p,uc as d}from"./chunk-FDOXBYU4.js";import"./chunk-GAL4ENT6.js";var T=(()=>{class r{constructor(t,o){this.http=t,this.router=o,this.apiUrl="/api/playqueue/status",this.authRedirectUrl="/api/login"}getQueueData(){return this.http.get(this.apiUrl).pipe(x(t=>this.handleError(t)))}handleError(t){return t.status===401&&(console.warn("Unauthorized (401) - Redirecting to login..."),window.location.href=this.authRedirectUrl),u(()=>new Error(t.message))}static{this.\u0275fac=function(o){return new(o||r)(c(C),c(_))}}static{this.\u0275prov=f({token:r,factory:r.\u0275fac,providedIn:"root"})}}return r})();function R(r,l){if(r&1&&(i(0,"tr"),e(1,`
                `),i(2,"th",7),e(3),n(),e(4,`
                `),i(5,"td"),e(6),n(),e(7,`
