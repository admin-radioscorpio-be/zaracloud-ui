import{b as z}from"./chunk-W6EE3F42.js";import{Qb as U,a as b,bb as j,cb as R,k as y,ra as T,sa as w,va as F}from"./chunk-ASRPS2K4.js";import{A as S,Ab as c,Kb as m,Vb as n,Wb as i,Yb as u,Z as E,Zb as v,ca as h,dd as I,ec as d,ed as D,fb as o,gb as _,m as f,rc as e,sc as p,tb as g,tc as x,uc as C}from"./chunk-TA7IZMCV.js";import"./chunk-Q7L6LLAK.js";var A=(()=>{class r{constructor(t,a){this.http=t,this.router=a,this.apiUrl="/api/scheduler/status",this.authRedirectUrl="/api/login"}getSchedulerData(){return this.http.get(this.apiUrl).pipe(S(t=>this.handleError(t)))}handleError(t){return t.status===401&&(console.warn("Unauthorized (401) - Redirecting to login..."),window.location.href=this.authRedirectUrl),f(()=>new Error(t.message))}static{this.\u0275fac=function(a){return new(a||r)(h(b),h(y))}}static{this.\u0275prov=E({token:r,factory:r.\u0275fac,providedIn:"root"})}}return r})();function $(r,l){if(r&1&&(u(0),e(1),v()),r&2){let t=d().$implicit;o(),x(`
                  `,t.event.fichero,`
