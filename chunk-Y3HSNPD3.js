import{b as _}from"./chunk-UFTR7SYY.js";import{Aa as n,Bc as I,E as g,Eb as C,H as m,Ha as v,Ra as t,Sa as l,Wd as T,ca as a,da as f,ga as h,hd as w,i as p,id as y,la as d,nb as u,oa as s,ob as E,q as x,ub as S,xc as b,yc as D,za as i}from"./chunk-B34ZBDND.js";import"./chunk-Q7L6LLAK.js";var k=(()=>{class r{constructor(e,o){this.http=e,this.router=o,this.apiUrl="https://zaracloud.radioscorpio.be/api/tracklogger/status",this.authRedirectUrl="https://zaracloud.radioscorpio.be/api/login"}getLoggerData(){return this.http.get(this.apiUrl).pipe(x(e=>this.handleError(e)))}handleError(e){return e.status===401&&(console.warn("Unauthorized (401) - Redirecting to login..."),window.location.href=this.authRedirectUrl),p(()=>new Error(e.message))}static{this.\u0275fac=function(o){return new(o||r)(m(S),m(C))}}static{this.\u0275prov=g({token:r,factory:r.\u0275fac,providedIn:"root"})}}return r})();function R(r,c){if(r&1&&(i(0,"tr"),t(1,`
  ...
  `),i(3,"c-col",1),t(4,`
    ...
    `),n(),t(39,`
  `),n(),t(40,`
`),n()()),r&2){let e=v();a(33),s("ngForOf",e.tracks)}}var P=(()=>{class r{constructor(e){this.loggerService=e,this.tracks=[]}ngOnInit(){this.loggerService.getLoggerData().subscribe({next:e=>{this.tracks=e.tracks,console.log(e)},error:e=>console.error("Error fetching logger data",e)})}static{this.\u0275fac=function(o){return new(o||r)(f(k))}}static{this.\u0275cmp=h({type:r,selectors:[["log-tables"]],decls:3,vars:1,consts:[[4,"ngIf"],["xs","12"],[1,"mb-4"],["href","components/table/log"],["cTable",""],["scope","col"],[4,"ngFor","ngForOf"],["scope","row"]],template:function(o,L){o&1&&(i(0,"h1"),t(1,"Log"),n(),d(2,U,41,1,"div",0)),o&2&&(a(2),s("ngIf",L.loggerData))},dependencies:[u,E,y,w,b,I,D,_,T],encapsulation:2})}}return r})();export{P as LogComponent};
