import{b as Q}from"./chunk-D47ZVGSA.js";import{Ia as I,Ja as w,Y as _,Z as D,a as C,aa as y,k as b,vb as k}from"./chunk-5N3J46XI.js";import{$c as g,A as x,Hb as s,Sb as i,Tb as n,Y as f,ad as S,ba as l,bc as E,db as a,eb as h,m as u,oc as e,pc as p,qb as v,qc as d,xb as m}from"./chunk-CTTX4CO2.js";import"./chunk-Q7L6LLAK.js";var T=(()=>{class r{constructor(t,o){this.http=t,this.router=o,this.apiUrl="https://zaracloud.radioscorpio.be/api/playqueue/status",this.authRedirectUrl="https://zaracloud.radioscorpio.be/api/login"}getQueueData(){return this.http.get(this.apiUrl).pipe(x(t=>this.handleError(t)))}handleError(t){return t.status===401&&(console.warn("Unauthorized (401) - Redirecting to login..."),window.location.href=this.authRedirectUrl),u(()=>new Error(t.message))}static{this.\u0275fac=function(o){return new(o||r)(l(C),l(b))}}static{this.\u0275prov=f({token:r,factory:r.\u0275fac,providedIn:"root"})}}return r})();function R(r,c){if(r&1&&(i(0,"tr"),e(1,`
                `),i(2,"th",7),e(3),n(),e(4,`
                `),i(5,"td"),e(6),n(),e(7,`
