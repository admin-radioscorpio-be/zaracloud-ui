import{b as j}from"./chunk-DRUIO7WJ.js";import{$ as I,La as $,Ma as F,aa as T,da as w,yb as R}from"./chunk-YNQMBS6W.js";import{a as b,j as D}from"./chunk-UFHHX7OZ.js";import{A as C,Ab as c,Lb as x,Wb as n,Xb as r,Z as v,Zb as d,_b as s,ca as g,fb as a,fc as m,gb as S,m as _,od as y,pd as M,sc as t,tb as E,tc as u,uc as f}from"./chunk-FDOXBYU4.js";import"./chunk-GAL4ENT6.js";var U=(()=>{class i{constructor(e,o){this.http=e,this.router=o,this.apiUrl="/api/mixer/status",this.authRedirectUrl="/api/login"}getMixerData(){return this.http.get(this.apiUrl).pipe(C(e=>this.handleError(e)))}handleError(e){return e.status===401&&(console.warn("Unauthorized (401) - Redirecting to login..."),window.location.href=this.authRedirectUrl),_(()=>new Error(e.message))}static{this.\u0275fac=function(o){return new(o||i)(g(b),g(D))}}static{this.\u0275prov=v({token:i,factory:i.\u0275fac,providedIn:"root"})}}return i})();function A(i,l){if(i&1&&(d(0),t(1),s()),i&2){let e=m().$implicit;a(),f(`
                    `,e.filename,`
