import{b as z}from"./chunk-DRUIO7WJ.js";import{$ as T,La as j,Ma as R,aa as w,da as F,yb as U}from"./chunk-YNQMBS6W.js";import{a as b,j as y}from"./chunk-UFHHX7OZ.js";import{A as S,Ab as c,Lb as m,Wb as n,Xb as i,Z as E,Zb as u,_b as v,ca as h,fb as o,fc as d,gb as _,m as f,od as I,pd as D,sc as e,tb as g,tc as p,uc as x,vc as C}from"./chunk-FDOXBYU4.js";import"./chunk-GAL4ENT6.js";var A=(()=>{class r{constructor(t,a){this.http=t,this.router=a,this.apiUrl="/api/scheduler/status",this.authRedirectUrl="/api/login"}getSchedulerData(){return this.http.get(this.apiUrl).pipe(S(t=>this.handleError(t)))}handleError(t){return t.status===401&&(console.warn("Unauthorized (401) - Redirecting to login..."),window.location.href=this.authRedirectUrl),f(()=>new Error(t.message))}static{this.\u0275fac=function(a){return new(a||r)(h(b),h(y))}}static{this.\u0275prov=E({token:r,factory:r.\u0275fac,providedIn:"root"})}}return r})();function $(r,l){if(r&1&&(u(0),e(1),v()),r&2){let t=d().$implicit;o(),x(`
                  `,t.event.fichero,`
