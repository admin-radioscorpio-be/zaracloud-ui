import{b as Q}from"./chunk-W6EE3F42.js";import{Qb as k,a as C,bb as I,cb as w,k as b,ra as _,sa as D,va as y}from"./chunk-ASRPS2K4.js";import{A as x,Ab as m,Kb as s,Vb as i,Wb as n,Z as f,ca as l,dd as g,ec as E,ed as S,fb as a,gb as h,m as u,rc as e,sc as p,tb as v,tc as d}from"./chunk-TA7IZMCV.js";import"./chunk-Q7L6LLAK.js";var T=(()=>{class r{constructor(t,o){this.http=t,this.router=o,this.apiUrl="https://zaracloud.radioscorpio.be/api/playqueue/status",this.authRedirectUrl="https://zaracloud.radioscorpio.be/api/login"}getQueueData(){return this.http.get(this.apiUrl).pipe(x(t=>this.handleError(t)))}handleError(t){return t.status===401&&(console.warn("Unauthorized (401) - Redirecting to login..."),window.location.href=this.authRedirectUrl),u(()=>new Error(t.message))}static{this.\u0275fac=function(o){return new(o||r)(l(C),l(b))}}static{this.\u0275prov=f({token:r,factory:r.\u0275fac,providedIn:"root"})}}return r})();function R(r,c){if(r&1&&(i(0,"tr"),e(1,`
                `),i(2,"th",7),e(3),n(),e(4,`
                `),i(5,"td"),e(6),n(),e(7,`
