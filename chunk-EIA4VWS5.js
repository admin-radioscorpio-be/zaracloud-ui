import{b as j}from"./chunk-UFTR7SYY.js";import{Aa as r,Bc as w,Ca as d,Da as s,E as v,Eb as D,H as h,Ha as m,Ra as t,Sa as E,Ta as f,Wd as R,ca as a,da as u,ga as S,hd as $,i as _,id as F,la as c,nb as b,oa as p,ob as y,q as C,ub as M,xc as I,yc as T,za as n}from"./chunk-B34ZBDND.js";import"./chunk-Q7L6LLAK.js";var U=(()=>{class i{constructor(e,o){this.http=e,this.router=o,this.apiUrl="https://zaracloud.radioscorpio.be/api/mixer/status",this.authRedirectUrl="https://zaracloud.radioscorpio.be/api/login"}getMixerData(){return this.http.get(this.apiUrl).pipe(C(e=>this.handleError(e)))}handleError(e){return e.status===401&&(console.warn("Unauthorized (401) - Redirecting to login..."),window.location.href=this.authRedirectUrl),_(()=>new Error(e.message))}static{this.\u0275fac=function(o){return new(o||i)(h(M),h(D))}}static{this.\u0275prov=v({token:i,factory:i.\u0275fac,providedIn:"root"})}}return i})();function k(i,l){if(i&1&&(d(0),t(1),s()),i&2){let e=m().$implicit;a(),f(`
                    `,e.filename,`
