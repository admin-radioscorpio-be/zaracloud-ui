import{b as U}from"./chunk-UFTR7SYY.js";import{Aa as i,Bc as F,Ca as u,Da as v,E,Eb as y,H as h,Ha as d,Ra as e,Sa as p,Ta as x,Ua as C,Wd as R,ca as o,da as _,ga as g,hd as j,i as f,id as z,la as c,nb as I,oa as m,ob as b,q as S,ub as D,xc as T,yc as w,za as n}from"./chunk-B34ZBDND.js";import"./chunk-Q7L6LLAK.js";var A=(()=>{class r{constructor(t,a){this.http=t,this.router=a,this.apiUrl="https://zaracloud.radioscorpio.be/api/scheduler/status",this.authRedirectUrl="https://zaracloud.radioscorpio.be/api/login"}getSchedulerData(){return this.http.get(this.apiUrl).pipe(S(t=>this.handleError(t)))}handleError(t){return t.status===401&&(console.warn("Unauthorized (401) - Redirecting to login..."),window.location.href=this.authRedirectUrl),f(()=>new Error(t.message))}static{this.\u0275fac=function(a){return new(a||r)(h(D),h(y))}}static{this.\u0275prov=E({token:r,factory:r.\u0275fac,providedIn:"root"})}}return r})();function $(r,l){if(r&1&&(u(0),e(1),v()),r&2){let t=d().$implicit;o(),x(`
                  `,t.event.fichero,`
