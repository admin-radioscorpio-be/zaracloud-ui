...
@Component({
  ...
  `,
  // packging the icon SVG inside a component has the following advantages:
  // - avoid using `fontawesome` as peerDependency to simplify usage
  // - avoid inlining CSS/font icons in the bundle at a huge size cost
  // - avoid dealing with assets and paths with ngpackagr
  template: `
    @switch (type()) {
      @case ("bars") {
...
export class VoyageIconComponent {
