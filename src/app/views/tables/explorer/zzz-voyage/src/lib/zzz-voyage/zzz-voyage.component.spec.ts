...
import { ZzzVoyageComponent } from "./zzz-voyage.component";
import { provideNoopAnimations } from "@angular/platform-browser/animations";

@Component({
  selector: "zzz-voyage-test",
  imports: [ZzzVoyageComponent],
  template: `
    <zzz-voyage path="/" [files]="[]">
...
describe("ZzzVoyageComponent templates", () => {
...
describe("ZzzVoyageComponent", () => {
  let component: ZzzVoyageComponent;
  let fixture: ComponentFixture<ZzzVoyageComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(ZzzVoyageComponent);
    component = fixture.componentInstance;
